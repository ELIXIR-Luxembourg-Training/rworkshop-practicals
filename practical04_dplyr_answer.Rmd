...
##### Find the moral dilemma with the highest average score across all participants.{.bonus}
  
Use the judgements data from Part one. The result should be a tibble containing the dilemma and the average such that the dilemma with the highest average in the first row. 
